...
const AcademicFeeStudentScreen = () => {
    ...
    return (
        <div className='h-screen p-10'>
            ...
            <span className=' mr-2 mb-4'>Academic Fee for this sem: </span>
            ...
            <br/>
            <span className=' mr-2 mb-2 text-sm italic text-gray-500'>To download the academic fee brochure </span>
...
export default AcademicFeeStudentScreen;