        ...
        <div>
            <nav className='bg-[#9a4b4c] border-y-2 p-2 flex flex-wrap justify-between items-center'>
                ...
                <div className='flex flex-row justify-center items-center'>
                    <Link to="/staff" className='border-0 border-black text-lg mr-4 p-2 rounded-md w-fit h-fit'>
                        Dashboard
                    </Link>
                    <img onClick={()=> console.log(userDetails)} src={profileSVG} alt='logo' className='mr-4 w-8 h-8' />
